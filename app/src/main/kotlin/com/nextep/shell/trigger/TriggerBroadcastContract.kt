package com.nextep.shell.trigger
...
object TriggerBroadcastContract {
    const val ACTION_TOGGLE_WORKSPACE = "com.nextep.shell.action.TOGGLE_WORKSPACE"
    const val ACTION_SET_WORKSPACE = "com.nextep.shell.action.SET_WORKSPACE"
    const val ACTION_QUERY_WORKSPACE = "com.nextep.shell.action.QUERY_WORKSPACE"
    const val ACTION_HOST_TOGGLE_REQUEST = "com.nextep.shell.action.HOST_TOGGLE_REQUEST"
    const val ACTION_HOST_SET_REQUEST = "com.nextep.shell.action.HOST_SET_REQUEST"
    const val ACTION_SYSTEMUI_SET_WORKSPACE = "com.nextep.shell.action.SYSTEMUI_SET_WORKSPACE"
    const val ACTION_LAUNCH_SLOT_TEST = "com.nextep.shell.action.LAUNCH_SLOT_TEST"
    const val ACTION_LAUNCHER_APP_REQUEST = "com.nextep.shell.action.LAUNCHER_APP_REQUEST"
    const val CONTROL_PERMISSION = "com.nextep.shell.permission.CONTROL_WORKSPACE"
    const val EXTRA_SOURCE = "com.nextep.shell.extra.TRIGGER_SOURCE"
    const val EXTRA_ACTIVE = "com.nextep.shell.extra.WORKSPACE_ACTIVE"
    const val EXTRA_REQUESTED_ACTIVE = "com.nextep.shell.extra.REQUESTED_ACTIVE"
    const val EXTRA_HOME_PACKAGE = "com.nextep.shell.extra.HOME_PACKAGE"
    const val EXTRA_RUNTIME_PROTOCOL_VERSION = "com.nextep.shell.extra.RUNTIME_PROTOCOL_VERSION"
    const val EXTRA_SLOT_STATES = "com.nextep.shell.extra.SLOT_STATES"
    const val EXTRA_LAUNCH_INTENT = "com.nextep.shell.extra.LAUNCH_INTENT"
    const val EXTRA_LAUNCHER_IDENTITY = "com.nextep.shell.extra.LAUNCHER_IDENTITY"
    const val EXTRA_SYSTEMUI_IDENTITY = "com.nextep.shell.extra.SYSTEMUI_IDENTITY"
    const val EXTRA_TARGET_USER = "com.nextep.shell.extra.TARGET_USER"
    const val EXTRA_TARGET_USER_ID = "com.nextep.shell.extra.TARGET_USER_ID"
    const val EXTRA_BYPASS_MULTI_APP_CHOOSER =
        "com.nextep.shell.extra.BYPASS_MULTI_APP_CHOOSER"
    const val RUNTIME_PROTOCOL_VERSION = 39
    const val RESULT_HANDLED = 0x4E58
    const val RESULT_NOT_READY = 0

    const val SYSTEM_UI_PACKAGE = "com.android.systemui"
    const val MODULE_PACKAGE = "com.nextep.shell"
    ...
    fun hostToggleIntent(): Intent = Intent(ACTION_HOST_TOGGLE_REQUEST).setComponent(
        ComponentName(
            MODULE_PACKAGE,
            "com.nextep.shell.trigger.WorkspaceControlBrokerReceiver",
        ),
    )
